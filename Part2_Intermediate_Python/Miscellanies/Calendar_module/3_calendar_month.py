...
cal_month = calendar.month(2022, 6, w=4)
print(cal_month)


# Calendar for a specific month
# The calendar module has a function called month, which allows you to display a calendar for a specific month. Its use is really simple, you just need to specify the year and 
# month - check out the code in the editor.
