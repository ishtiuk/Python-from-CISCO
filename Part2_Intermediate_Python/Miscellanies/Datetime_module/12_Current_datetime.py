...
print("utcnow:", datetime.utcnow())        # BST - GMT or UTC + 6

print("Today BD Time", datetime.utcfromtimestamp(time.time()))

print("Today BD Time", datetime.utcnow())
...
# now() — returns the current local date and time the same as the today method, unless we pass the optional argument tz to it. The argument of this method must
# be an object of the tzinfo subclass;
